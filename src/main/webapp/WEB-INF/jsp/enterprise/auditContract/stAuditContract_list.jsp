...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
		...
		<!-- 检索  -->
		<form action="stAuditContract/list.do" method="post" name="stAuditContractForm" id="stAuditContractForm">
			<table>
				<tr>
					<td>
		...
		function add(){
			 ...
			 diag.Drag=true;
			 diag.Title ="新增";
			 diag.URL = '/stAuditContract/goAdd.do';
			 diag.Width = 800;
			 diag.Height = 500;
		...
		function edit(ID){
			 ...
			 diag.Drag=true;
			 diag.Title ="资料";
			 diag.URL = '/stAuditContract/goEdit.do?ID='+ID;
			diag.Width = 800;
			diag.Height = 500;
			 diag.CancelEvent = function(){ //关闭事件
				 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
		...
		function del(ID){
			bootbox.confirm("确定要删除吗?", function(result) {
				if(result) {
					top.jzts();
					var url = "/stAuditContract/delete.do?ID="+ID;
