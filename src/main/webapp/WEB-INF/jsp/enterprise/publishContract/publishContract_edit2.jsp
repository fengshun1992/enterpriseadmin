...
<form action="publishContract2/${msg }.do" name="form" id="form" method="post" enctype="multipart/form-data">
    ...
    <div id="zhongxin">
        <table id="table_report" class="table table-striped table-bordered table-hover">
            <tr>
                <td style="width:100px;text-align: right;padding-top: 13px;">合同文件:</td>
                <td>
                    <c:choose>
                        ...
                        <c:otherwise>
                            <span style="color: red">合同生成失败,请联系管理方</span>
                        </c:otherwise>
                    </c:choose>
                </td>
            </tr>
            <tr>
                <td style="width:100px;text-align: right;padding-top: 13px;">附件上传:</td>
                <td>
            ...
            <tr>
                <td style="text-align: center;" colspan="10">
                    <a class="btn btn-mini btn-primary" onclick="save();">发行</a>
