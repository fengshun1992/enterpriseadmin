...
<body>
	...
	<div class="container-fluid" id="main-container">
			...
			<div id="page-content" class="clearfix">
				...
				<div class="row-fluid" style="width: 100%;font-size: 28px;font-weight: 200;color: #777;text-shadow: 0 1px 0 rgba(0,0,0,0.2);text-align: center;padding-top: 304px;">
					欢迎登陆<%=sysName%>
				</div>
				<!--/row-->
		</div>
