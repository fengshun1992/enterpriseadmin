<%@ page import="com.admin.util.Tools" %>
<%@ page import="com.admin.util.Const" %>
<%@ page language="java" contentType="text/html; charset=UTF-8"
		 pageEncoding="UTF-8"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<%
	String path = request.getContextPath();
	String sysName = "企业自动化后台管理系统";
	String url = request.getRequestURL().toString();
	if(url.indexOf("sales") > 0){
		sysName = "银票网CRM系统"; //读取系统名称
	}
%>
<!DOCTYPE html>
<html lang="en">
...
<div
		style="width:100%;height: 100%; text-align: center;margin: 0 auto;position: absolute; background-image: url('static/login/images/banner_slide_02.jpg')">
	<div id="loginbox">
		...
		<%--<div class="controls">
			<div class="main_input_box">
				<font color="white"><span id="nameerr">copyright©2016 <a href="http://www.yinpiao.com"><span style="color: #006600">www.yinpiao.com</span></a>
							</span></font>
			</div>
		</div>--%>
	</div>
