        ...
        getAllPic: function (sel, $w, editor) {
            ...
            $.each($imgs, function (index, node) {
               // $(node).removeAttr("width").removeAttr("height");
                //$(node).attr("width",imgWidth).attr("height",imgheight);
                console.log(node);
                console.log(index);
...
//                    }
        ...
        callback: function (editor, $w, url,width,height,  state) {
    ...
    var Upload = {
        ...
        uploadComplete: function(r){
            ...
            try{
                var json = eval('('+r+')');
                Base.callback(me.editor, me.dialog, json.url,json.width,json.height, json.state);
            }catch (e){
    ...
    UM.registerWidget('image', {
        ...
        width: 700,
        height: 408
    }, function (editor, $w, url,width,height, state) {
        Base.callback(editor, $w, url,width,height, state)
    })
})();
