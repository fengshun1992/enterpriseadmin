...
public class UserService {
	...
	public List<PageData> listPdPageUserRoleZ(Page page) throws Exception {
		return (List<PageData>) dao.findForList("UserXMapper.userlistPageRoleZ", page);
	}


	public List<PageData> listPdPageUserRoleP(Page page) throws Exception {
		return (List<PageData>) dao.findForList("UserXMapper.userlistPageRoleP", page);
	}
	/*
	 * 用户列表(全部)
	 */
	 ...
	 * 通过id获取数据
	 */
	public User getUserAndRoleById(Map map) throws Exception {
		return (User) dao.findForObject("UserMapper.getUserAndRoleById", map);
	}

	/*
     * 通过id获取数据
     */
	public User getUserAndRoleByAll(Map map) throws Exception {
		return (User) dao.findForObject("UserMapper.getUserAndRoleByAll", map);
	}

	/*
     * 注销
     */
	public void logOutUser(PageData pd) throws Exception {
		dao.update("UserXMapper.logOutUser", pd);
	}

	/*
     * 注销特定角色用户
     */
	public void logOutRoleUser(PageData pd) throws Exception {
		dao.update("UserXMapper.logOutRoleUser", pd);
	}

    /*
     * 商户列表
     */
	public List<PageData> listAllOwner() throws Exception {
		return (List<PageData>) dao.findForList("UserXMapper.listAllOwner",null);
	}
}
